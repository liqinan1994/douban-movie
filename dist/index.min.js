...
define('top250',['jquery','helper'],function($,helper){
	var top250 = {
		init: function(){
			var _this = this
	       this.$element = $('#top250')
...
define('usBox',['jquery','helper'],function($,helper){
	//北美
	var usBox = {
		init: function(){
	      this.$element = $('#beimei')
...
define('search',['jquery','helper'],function($,helper){
	//搜索
	var search = {
		init: function(){
...
define('app',['top250','usBox','search','jquery'],function(top250,usBox,search,$){
	var app = {
		init: function(){
